...
if(isset($_POST["submit"])){
  ...
  $duplicate = mysqli_query($conn, "SELECT * FROM project_login WHERE username = '$username' OR email = '$email'");
  if(mysqli_num_rows($duplicate) > 0){
    ...
    if($password == $confirmpassword){
      $query = "INSERT INTO project_login VALUES('','$name','$username','$email','$password')";
